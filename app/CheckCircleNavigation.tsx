...
export function CheckCircleNavigation({ currentUser }: { currentUser: any }) {
  ...
  return (
    <>
      <div className="fixed bottom-20 right-4 z-50 ml-auto w-fit flex items-center justify-center">
        <CircleButtonWithAlert />
      </div>
      <div className="fixed bottom-6 right-4 z-50 ml-auto w-fit flex items-center justify-center">
        <Link href="/main">
          <div
