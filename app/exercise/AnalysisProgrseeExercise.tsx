...
const AnalysisProgressExercise: React.FC<AnalysisProgressProps> = ({ currentStep }) => {
  ...
  const steps: Record<StepKey, StepInfo> = {
    ...
    calculate: { icon: Calculator, text: '소모 칼로리를 계산하고 있어요' },
  };
...
export default AnalysisProgressExercise;
