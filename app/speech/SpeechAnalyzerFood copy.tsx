...
const SpeechAnalyzerFood = () => {
        ...
        if (!isAnalyzing) {
          ...
          if (transcript.trim()) {
            setFullTranscript((prev) => {
              ...
              console.log('저장된 글자:', transcript);
              console.log('누적된 글자:', updated);
              return updated;
            });
          }
  ...
  // 현재 말하는 중인 것도 보여주기 위한 실시간 업데이트
  useEffect(() => {
    if (listening && transcript) {
      setInputText(`${fullTranscript} ${transcript}`.trim());
    }
  }, [transcript, listening, fullTranscript]);
